...
users = {'jake':'bacon', 'Ethan':'simplePass'}
...
class Video(flask.views.MethodView):
	@login_required
	def get(self):
		videos = os.listdir('static/video/')
		return flask.render_template('video.html', videos=videos)
...
app.add_url_rule('/music/',
				 ...
				 methods=['GET'])
app.add_url_rule('/video/',
				 view_func=Video.as_view('video'),
				 methods=['GET'])
app.debug = True
app.run()